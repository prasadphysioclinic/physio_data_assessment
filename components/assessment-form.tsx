        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                    ...
                                    <>
                                        ...
                                        <div className="absolute inset-x-0 bottom-8 flex justify-center items-center gap-8 px-4">
                                            <div className="flex flex-col items-center gap-2 group">
                                                <Button type="button" size="lg" className="h-20 w-20 rounded-full bg-white text-primary border-[6px] border-primary/10 shadow-2xl transition-none active:scale-[0.98] flex items-center justify-center p-0" onClick={takePhoto} disabled={mediaFiles.length >= 4}><Camera className="h-8 w-8" /></Button>
                                            ...
                                            <div className="flex flex-col items-center gap-2 group">
                                                {!isRecording ? (
                                                    <Button type="button" size="lg" className="h-20 w-20 rounded-full bg-red-600 text-white border-[6px] border-red-200/20 shadow-2xl transition-none active:scale-[0.98] flex items-center justify-center p-0" onClick={startRecording} disabled={mediaFiles.length >= 4}><Video className="h-8 w-8" /></Button>
                                                ) : (
                ...
                <div className="flex justify-between items-center bg-white p-6 rounded-3xl shadow-xl border border-slate-100">
                    <Button type="button" variant="ghost" asChild className="rounded-xl h-12 px-6 font-bold text-slate-400 hover:text-slate-900 transition-none active:scale-[0.98]"><Link href="/"><ArrowLeft className="h-4 w-4 mr-2" /> Back to Dashboard</Link></Button>
